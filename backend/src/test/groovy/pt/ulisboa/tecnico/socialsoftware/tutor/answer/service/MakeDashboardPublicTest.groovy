...
@DataJpaTest
class MakeDashboardPublicTest extends  Specification{
    ...
    def 'Making Dashboard Public (Change Privacy to false)'(){
        ...
        answerService.getStudentDashboard("rcosta1944", 1)
        then:
        def result = answerService.makeDdpDashboardPublic("rcosta1944")
        result == false
    }
