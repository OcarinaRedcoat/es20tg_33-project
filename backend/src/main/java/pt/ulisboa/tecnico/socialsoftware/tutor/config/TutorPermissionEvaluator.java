...
public class TutorPermissionEvaluator implements PermissionEvaluator {
        ...
        if (targetDomainObject instanceof Integer) {
            ...
            switch (permissionValue) {
                ...
                case "TOURNEY.CREATOR":
                    return userHasCreatedTheTourney(userId, id);
                ...
                case "STUDENT_QUESTION.ACCESS":
                    return userHasAnExecutionOfTheCourse(userId, studentQuestionService.findQuestionCourse(id).getCourseId());
                case "TOPIC.ACCESS":
    ...
    private boolean userHasCreatedTheTourney(int userId, int id) {
        return userService.getCreatedTourneys(userId).stream()
