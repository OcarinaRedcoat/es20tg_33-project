...
#### Feature number 3: (PpA:F6)_Uma pergunta rejeitada pode ser alterada e resubmetida pelo aluno_
 ...
 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20tg_33-project/blob/develop/frontend/tests/e2e/specs/student/resubmitQuestion.js)
   + Screenshot: 
     ...
     ![Test results](https://github.com/tecnico-softeng/es20tg_33-project/blob/add-p4.md/p4-images/PpA/ResubmitStudentQuestion_cypress.png)
...
#### Feature number 4: (PpA:F7)_Existe um dashboard do aluno onde é apresentada informação acerca do seu número de perguntas propostas e aprovadas_
 ...
 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20tg_33-project/blob/develop/frontend/tests/e2e/specs/student/studentQuestionDashboard.js)
   + Screenshot: 
     ...
     ![Test results](https://github.com/tecnico-softeng/es20tg_33-project/blob/add-p4.md/p4-images/PpA/StudentQuestionDashboard_cypress.png)
