...
#### Controllers
 ...
 - [PUT Approve/Reject submitted questions](https://github.com)
 - [GET Get submitted questions information](https://github.com)
...
Each subgroup member defined one reading test and one writing test. The direct links to these are:
 ...
 - [Approve/Reject submitted questions](https://github.com)
 - [Get submitted questions information](https://github.com)
...
![Response body](backend/assets/img/)
![Summary report](backend/assets/img/)
![DB Cleanup](backend/assets/img/)
...
![Profiling percentages](backend/assets/img/)
![Profiling graphs](backend/assets/img/)
![Profiling heap](backend/assets/img/)
...
Repository functions, like findAll, should be avoided as much as possible. When creating a Dto object we should be careful with what atributes are copied, especially lists.
