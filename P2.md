...
![Profiling percentages](backend/assets/ApproveRejectPerformace/ApproveQuestionProfiler.png)
![Profiling percentages](backend/assets/ApproveRejectPerformace/RejectQuestionProfiler.png)
...
![Profiling percentages](backend/assets/img/img/getQuestionStatusPerfomace/getQuestionStatusVVMprofiler.png)
...
Functions like finById and findAll (Repository function) are very demanding and should be avoided whenever possible.
